...
export const PROJECTS = [
	{
		...
		images: [
			`${import.meta.env.BASE_URL}/images/sgcd/panel-estadisticas.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/crear-incidente-1.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/ver-incidentes.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/crear-incidente-2.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/gestion-camaras.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/gestion-usuarios.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/ubicaciones/ubicaciones-1.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/ubicaciones/ubicaciones-2.png`,
			`${import.meta.env.BASE_URL}/images/sgcd/ubicaciones/ubicaciones-3.png`,
		],
	},
	{
		...
		images: [
			`${import.meta.env.BASE_URL}/images/api/login.png`,
			`${import.meta.env.BASE_URL}/images/api/personas.png`,
			`${import.meta.env.BASE_URL}/images/api/ciudades.png`,
			`${import.meta.env.BASE_URL}/images/api/localidades.png`,
			`${import.meta.env.BASE_URL}/images/api/oficinas.png`,
			`${import.meta.env.BASE_URL}/images/api/exportar.png`,
